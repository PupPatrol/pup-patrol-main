...
function Accordion() {
	...
	return (
		<div className='w-full my-10 lg:my-16 text-white'>
			<div>
				<hr />
				<button
					onClick={() => setIsOpen1(!isOpen1)}
					className='p-4 w-full text-lg flex items-center justify-between transition-colors cursor-pointer hover:bg-hover-color  focus-visible:outline-2 text-left'>
					Technical data
					<img
						src={arrowDownIcon}
						alt='arrow down'
				...
				{isOpen1 && (
					<div className='max-w-purse'>
						<ul className='list-disc pl-4 mb-5 marker:text-black lg:mb-10'>
							<li>lorem 1 528547</li>
							<li>lorem 2 567651</li>
							<li>lorem 3</li>
							<li>lorem 4</li>
							<li>lorem 5</li>
						</ul>
